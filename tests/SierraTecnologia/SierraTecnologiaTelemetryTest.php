...
class SierraTecnologiaTelemetryTest extends TestCase
{
    ...
    public function testNoTelemetrySentIfNotEnabled()
    {
        ...
        Charge::all();
        $this->assertArrayNotHasKey('X-SierraTecnologia-Client-Telemetry', $requestheaders);
    ...
    {
        SierraTecnologia::setEnableTelemetry(true);
        ...
        Charge::all();
        $this->assertArrayHasKey('X-SierraTecnologia-Client-Telemetry', $requestheaders);

        $data = json_decode($requestheaders['X-SierraTecnologia-Client-Telemetry'], true);
