...
class CustomerTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\Customer", $resources->data[0]);
    }
    ...
    public function testCanListInvoiceItems()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertInstanceOf("SierraTecnologia\\InvoiceItem", $resources->data[0]);
    }
    ...
    public function testCanListCharges()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertInstanceOf("SierraTecnologia\\Charge", $resources->data[0]);
    }
    ...
    public function testCanUpdateSource()
    {
        ...
        // sierratecnologia-mock returns a Card on this method and not a bank account
        $this->assertInstanceOf("SierraTecnologia\\Card", $resource);
    }
