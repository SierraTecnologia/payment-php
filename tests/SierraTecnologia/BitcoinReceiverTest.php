...
class BitcoinReceiverTest extends TestCase
{
    ...
    // Because of the wildcard nature of sources, sierratecnologia-mock cannot currently
    ...
    public function testIsListable()
    {
        ...
        $this->assertSame("SierraTecnologia\\BitcoinReceiver", get_class($resources->data[0]));
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertSame("SierraTecnologia\\BitcoinReceiver", get_class($resource));
    }
}
