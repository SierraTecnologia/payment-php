...
class ApplicationFeeTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\ApplicationFee", $resources->data[0]);
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\ApplicationFee", $resource);
    }
    ...
    public function testCanCreateRefund()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\ApplicationFeeRefund", $resource);
    }
    ...
    public function testCanListRefunds()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertInstanceOf("SierraTecnologia\\ApplicationFeeRefund", $resources->data[0]);
    }
}
