...
class UtilTest extends TestCase
{
    ...
    public function testConvertSierraTecnologiaObjectToArrayIncludesId()
    {
        $customer = Util\Util::convertToSierraTecnologiaObject(
            [
                'id' => 'cus_123',
                'object' => 'customer',
            ],
        ...
        $this->assertTrue(property_exists($customer->__toArray(true), "id"));
    }
