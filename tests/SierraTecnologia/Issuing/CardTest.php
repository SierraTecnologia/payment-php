...
class CardTest extends \SierraTecnologia\TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\Issuing\\Card", $resources->data[0]);
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\Issuing\\Card", $resource);
    }
    ...
    public function testCanRetrieveDetails()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\Issuing\\CardDetails", $details);
    }
}
