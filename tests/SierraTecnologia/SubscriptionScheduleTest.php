...
class SubscriptionScheduleTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\SubscriptionSchedule", $resources->data[0]);
    }
    ...
    public function testRevisions()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\SubscriptionScheduleRevision", $revisions->data[0]);
    }
    ...
    public function testCanRetrieveRevision()
    {
        ...
        $this->assertInstanceOf("SierraTecnologia\\SubscriptionScheduleRevision", $resource);
    }
