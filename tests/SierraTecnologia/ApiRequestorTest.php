...
class ApiRequestorTest extends TestCase
{
    ...
    {
        $reflector = new \ReflectionClass('SierraTecnologia\\ApiRequestor');
    ...
    public function testDefaultHeaders()
    {
        ...
        SierraTecnologia::setAppInfo('MyTestApp', '1.2.34', 'https://mytestapp.example', 'partner_1234');
        $apiKey = 'sk_test_notarealkey';
        $clientInfo = ['httplib' => 'testlib 0.1.2'];

        $headers = $method->invoke(null, $apiKey, $clientInfo);

        $ua = json_decode($headers['X-SierraTecnologia-Client-User-Agent']);
        ...
        $this->assertSame(
            $headers['User-Agent'],
            'SierraTecnologia/v1 PhpBindings/' . SierraTecnologia::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)'
        );
    ...
    {
        SierraTecnologia::setApiKey(null);
        Charge::create();
    }
    ...
    public function testRaisesInvalidRequestErrorOn400()
    {
        ...
        try {
            ...
            $this->assertSame('id', $e->getSierraTecnologiaParam());
        } catch (\Exception $e) {
    ...
    public function testRaisesCardErrorOn402()
    {
        ...
        try {
            ...
            $this->assertSame('card_declined', $e->getSierraTecnologiaCode());
            $this->assertSame('generic_decline', $e->getDeclineCode());
            $this->assertSame('exp_month', $e->getSierraTecnologiaParam());
        } catch (\Exception $e) {
            $this->fail("Unexpected exception: " . get_class($e));
        }
    }
    ...
    public function testHeaderSierraTecnologiaVersionGlobal()
    {
        SierraTecnologia::setApiVersion('2222-22-22');
        $this->stubRequest(
            'POST',
            '/v1/charges',
            [],
            [
                'SierraTecnologia-Version: 2222-22-22',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderSierraTecnologiaVersionRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/v1/charges',
    ...
    {
        SierraTecnologia::setAccountId('acct_123');
        $this->stubRequest(
            'POST',
            '/v1/charges',
            [],
            [
                'SierraTecnologia-Account: acct_123',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderSierraTecnologiaAccountRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/v1/charges',
