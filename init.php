...
// SierraTecnologia singleton
require(dirname(__FILE__) . '/lib/SierraTecnologia.php');
...
require(dirname(__FILE__) . '/lib/SierraTecnologiaObject.php');
require(dirname(__FILE__) . '/lib/ApiRequestor.php');
require(dirname(__FILE__) . '/lib/ApiResource.php');
require(dirname(__FILE__) . '/lib/SingletonApiResource.php');

// SierraTecnologia API Resources
